...
class ProductControllerTest {
    ...
    void should_successfully_get_by_id() throws Exception {
        ...
        when(productRepository.findById(any())).thenReturn(Optional.of(expectedType));
    ...
    void should_successfully_get_all() throws Exception {
        var expectedType = ProductStub.getRandomProduct();
        when(productRepository.findAll()).thenReturn(Collections.singletonList(expectedType));
